...
const plans = [
    {
        key: "free",
        name: "Free",
        description: "For trying out the bratCode IDE.",
        price: "₹0",
        period: "/month",
...
">
                    ...
                    <div className="text-sm font-semibold">bratCode AI</div>
                </div>
...
">
                  ...
                  ">
                                    {" "}
                                    <Zap size={14} className="text-indigo-500" fill="currentColor" /> {plan.credits}
                                </div>
